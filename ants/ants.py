    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                # BEGIN Problem 9
                if self.can_contain(insect):
                   self.contained_ant = insect
                elif insect.is_container:
                    insect.contained_ant = self
                else:
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        """
        # BEGIN Problem 5
        bees_lst = [x for x in self.place.bees]
